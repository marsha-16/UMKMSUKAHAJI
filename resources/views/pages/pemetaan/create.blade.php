                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="business" id="business" class="form-control @error('business') is-invalid @enderror">
                                ...
                                <option value="{{ $item->value }}" @selected(old('business') == $item->value)>{{ $item->label }}</option>
                                @endforeach
                            </select>
                            @error('business')
                                <span class="invalid-feedback">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="marketing" id="marketing" class="form-control @error('marketing') is-invalid @enderror">
                                    @foreach ([
                                        ...
                                        <option value="{{ $item->value }}" @selected(old('marketing') == $item->value)>{{ $item->label }}</option>
                                    @endforeach
                                </select>
                                @error('marketing')
                                <span class="invalid-feedback">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="promotion" id="promotion" class="form-control @error('promotion') is-invalid @enderror">
                                    @foreach ([
                                        ...
                                        <option value="{{ $item->value }}" @selected(old('promotion') == $item->value)>{{ $item->label }}</option>
                                    @endforeach
                                </select>
                                @error('promotion')
                                <span class="invalid-feedback">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="document" id="document" class="form-control @error('document') is-invalid @enderror">
                                    @foreach ([
                                        ...
                                        <option value="{{ $item->value }}" @selected(old('document') == $item->value)>{{ $item->label }}</option>
                                    @endforeach
                                </select>
                                @error('document')
                                <span class="invalid-feedback">
